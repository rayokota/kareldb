...
public class KarelDbCoordinatorTest {
    ...
    private static final KarelDbIdentity LEADER_INFO = new KarelDbIdentity(
        "http",
        LEADER_HOST,
        LEADER_PORT,
        true
    );
    private static final KarelDbIdentity INELIGIBLE_LEADER_INFO = new KarelDbIdentity(
        "http",
        LEADER_HOST,
        LEADER_PORT,
        false
    ...
    // We only test functionality unique to KarelDbCoordinator. Most functionality is already
    ...
    private static class MockRebalanceListener implements KarelDbRebalanceListener {
        public List<KarelDbProtocol.Assignment> assignments = new ArrayList<>();
