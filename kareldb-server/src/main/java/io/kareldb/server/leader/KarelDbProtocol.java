 ...
 */
class KarelDbProtocol {

    public static ByteBuffer serializeMetadata(KarelDbIdentity identity) {
        return identity.toJsonBytes();
    }

    public static KarelDbIdentity deserializeMetadata(ByteBuffer buffer) {
        return KarelDbIdentity.fromJson(buffer);
    }
    ...
    public static class Assignment {
        ...
        public KarelDbIdentity leaderIdentity() {
