...
public class KarelDbIdentity {
    ...
    public static KarelDbIdentity fromJson(String json) throws IOException {
        return new ObjectMapper().readValue(json, KarelDbIdentity.class);
    }

    public static KarelDbIdentity fromJson(ByteBuffer json) {
        try {
            byte[] jsonBytes = new byte[json.remaining()];
            json.get(jsonBytes);
            return new ObjectMapper().readValue(jsonBytes, KarelDbIdentity.class);
        } catch (IOException e) {
    ...
    public boolean equals(Object o) {
        ...
        KarelDbIdentity that = (KarelDbIdentity) o;
